...
class USNavyTextDataset(Dataset):
	def __init__(self, tokenizer: PreTrainedTokenizer, args, file_path: str, block_size=512):
		...
		for x_line, y_line in zip(X_lines, Y_lines):
			if len(y_line.strip()) > 0:
				lines.append("<BOS> " + x_line.strip() + " <SEP> " + y_line.strip() + " <EOS>")
...
def load_and_cache_examples(args, tokenizer, evaluate=False):
	...
	return USNavyTextDataset(tokenizer, args, file_path=file_path, block_size=args.block_size)
